package com.tangcheng.upload.controller;

import com.tangcheng.upload.service.StorageService;
...
public class FileUploadIntegrationTests {
    ...
    public void shouldDownloadFile() throws Exception {
        ClassPathResource resource = new ClassPathResource("testupload.txt", getClass());
        given(this.storageService.loadAsResource("com/tangcheng/upload/controller/testupload.txt")).willReturn(resource);
